...
<html lang="en">
    ...
    <body style="background-color: #a6a6a6">
        ...
        <nav class="navbar navbar-expand-lg"  style="background-color: #ffcccc">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a  style="color: tan; font-family: 'marck script',cursive;" class="nav-link" href="tampil.php">
                            NAMA EDITOR
                        </a>
                    </li>
                    <li class="nav-item active">
                        <a   style="color: white; font-family: 'marck script',cursive;" class="nav-link" href="about.php">
                            ABOUT ME
                        </a>
                    </li>
                </ul>
        ...
        <center>
            <p>
               <b style ="font-family: 'marck script',cursive; color:white">Namastae!!</b> <br>
               Nama :Cut Meutia Haura<br> 
               TTL : 19 Desember 1999<br>
               Status : Mahasiswi<br>
